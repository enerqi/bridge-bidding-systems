...
main {
    ...
    if {[is_weak2_major west] || [is_weak2_major east]} { accept }
    if {[is_generic_5card_unbal_weak2 west] || [is_generic_5card_unbal_weak2 east]} { accept }
    if {[is_generic_weak2d west] || [is_generic_weak2d east]} { accept }
