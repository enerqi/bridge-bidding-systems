...
@(private)
nt5cM :: proc(hand: norn.HandSummary, low, high: int) -> bool {
...
@(private)
has_pattern :: proc(hand: norn.HandSummary, a, b, c, d: int) -> bool {
...
@(private)
has_aqj :: proc(hand: norn.HandSummary, suit: norn.Suit) -> bool {
	return(
...
@(private)
has_kqj :: proc(hand: norn.HandSummary, suit: norn.Suit) -> bool {
	return(
