...
long_semi_solid :: proc(hand: norn.HandSummary, suit: norn.Suit) -> bool {
...
good_6_plus_suit :: proc(hand: norn.HandSummary, suit: norn.Suit) -> bool {
...
any_good_6_plus_carder :: proc(hand: norn.HandSummary) -> bool {
	return(
...
// `two_suiter`.)
two_suiter :: proc(hand: norn.HandSummary) -> bool {
	return(
...
is_6_plus_other_10_card_two_suiter :: proc(hand: norn.HandSummary) -> bool {
	return(
		has_pattern(hand, 6, 4, 2, 1) ||
		has_pattern(hand, 6, 4, 3, 0) ||
...
is_asymmetric_10_plus_two_suiter :: proc(hand: norn.HandSummary) -> bool {
	return(
		has_pattern(hand, 6, 4, 2, 1) ||
		has_pattern(hand, 6, 4, 3, 0) ||
		has_pattern(hand, 6, 5, 2, 0) ||
...
is_6_plus_other_11_or_more_card_two_suiter :: proc(hand: norn.HandSummary) -> bool {
	return(
		has_pattern(hand, 6, 5, 2, 0) ||
		has_pattern(hand, 6, 5, 1, 1) ||
...
majors_4_4 :: proc(hand: norn.HandSummary) -> bool {
...
is_unbalanced_minor :: proc(hand: norn.HandSummary) -> bool {
...
both_minors :: proc(hand: norn.HandSummary) -> bool {
	cs := norn.club_length(hand)
	ds := norn.diamond_length(hand)
...
// `is_tricky_suit`.)
is_tricky_suit :: proc(hand: norn.HandSummary, suit: norn.Suit) -> bool {
...
side_ace :: proc(hand: norn.HandSummary, suit: norn.Suit) -> bool {
...
has_major_support :: proc(opener, responder: norn.HandSummary, support_length: int) -> bool {
